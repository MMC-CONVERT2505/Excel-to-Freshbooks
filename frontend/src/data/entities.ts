...
export const TEMPLATES: Record<string, TplCol[]> = {
  ...
  'credit-notes': [
    ...
    { col:'customer_email',     req:false, ds:'Used to look up client if name does not match', ex:'ar@acme.com' },
    { col:'currency_code',      req:true,  ds:'3-letter ISO code e.g. USD', ex:'USD' },
    { col:'credit_type',        req:false, ds:'goodwill | overpayment | credit_note (default: goodwill)', ex:'goodwill' },
  ...
  'invoice-payments': [
    ...
    { col:'date',                req:true,  ds:'Payment date YYYY-MM-DD or DD-MM-YYYY', ex:'2026-05-22' },
    { col:'payment_type',        req:false, ds:'Check | Cash | Credit | Other (default: Check)', ex:'Check' },
    { col:'currency_code',       req:true,  ds:'3-letter ISO code e.g. USD', ex:'USD' },
  ...
  'bill-payments': [
    ...
    { col:'paid_date',           req:true,  ds:'Payment date YYYY-MM-DD or DD-MM-YYYY', ex:'2026-05-23' },
    { col:'payment_type',        req:false, ds:'Check | Cash | Credit | Other (default: Check)', ex:'Check' },
    { col:'currency_code',       req:true,  ds:'3-letter ISO code e.g. USD', ex:'USD' },
